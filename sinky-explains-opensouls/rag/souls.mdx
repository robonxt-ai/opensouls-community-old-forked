...
// Create a new Soul instance with a unique identifier
const soul = new Soul({
...
// Connect the soul to the engine using a new unique identifier
...
// Specify a soul instance with a unique identifier
const soul = new Soul({
  organization: "opensouls",
  blueprint: "samantha-provokes",
  id: "my-favorite-id",
