...
* `soul-engine` command line program now supports `install` to easily add community cognitiveSteps to your `soul/` directory (eg `npx soul-engine install cognitiveSteps/externalDialog`)
