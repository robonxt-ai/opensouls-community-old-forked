...
The [`@opensouls/pipeline`](https://github.com/opensouls/soul-engine/tree/main/packages/pipeline) project makes it simple to get started creating your own pipelines. Currently there's filesystem pipeline that supports text. Other formats will be supported later.
